...
// app/[locale]/projects/[projectId]/corpus/client.tsx
...
export function CorpusClient({
  ...
  const onSelectId = useCallback((ark: string | null) => setSelectedId(ark), [])
  ...
  const selectedDoc =
    selectedId && snapshot
      ? (snapshot.sample.find((d) => d.openaireId === selectedId) ?? null)
      : null
