...
export const DESCRIPTION = 'Merge multiple citation networks into a single unified network visualization. ' +
...
export async function execute(args) {
    try {
        ...
        const normalizedNetworks = networks.map((net) => ({
            ...net,
        ...
        const chart = {
            ...
            config: {
                ...
                description: description || `${merged.nodes.length} papers, ${merged.edges.length} citations`,
 ...
 */
function mergeCitationNetworks(networks) {
...
//# sourceMappingURL=merge_citation_networks.js.map