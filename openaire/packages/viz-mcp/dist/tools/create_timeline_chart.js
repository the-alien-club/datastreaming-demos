...
export const DESCRIPTION = 'Create a line chart showing trends over time (e.g., publications per year, citation growth). ' +
...
export const INPUT_SCHEMA = {
    ...
    properties: {
        data: {
            type: 'array',
            description: 'Array of time series data points. Each object should contain properties matching ' +
                'the xAxisKey (e.g., year) and yAxisKey (e.g., count)',
            items: {
                type: 'object',
                description: 'Data point with properties for the X and Y axes (e.g., { year: 2023, count: 42 })',
            },
        },
        title: {
            type: 'string',
...
//# sourceMappingURL=create_timeline_chart.js.map