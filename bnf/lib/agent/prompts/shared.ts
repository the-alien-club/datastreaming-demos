...
- When you need the user to choose between options (scope, period, languages, which subset to add, next step…), call \`ask_user\` with structured multiple-choice questions INSTEAD of writing "Option A / B / C" as prose. It renders clickable choices and ENDS your turn; the user's selections arrive as their next message. Write the questions and options in French.`
}
