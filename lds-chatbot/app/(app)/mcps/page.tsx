...
function McpDialog({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!form.serverUrl.trim()) { toast.error("Server URL is required"); return }
    ...
    try {
      ...
      toast.success(isNew ? "MCP created" : "MCP updated")
      onSaved(saved)
      onClose()
    } catch (err) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4 pt-2">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-1">
              ...
              <Input
                placeholder="e.g. research, data, legal"
                value={form.category}
          ...
          <div className="space-y-1">
            <label className="text-sm font-medium">Auth token <span className="text-muted-foreground font-normal">(optional)</span></label>
            <Input
              type="password"
          ...
          <div className="space-y-1">
            ...
            <Input
              placeholder="Short description shown in agent picker"
    ...
    <div className="p-6 max-w-4xl">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Manage Model Context Protocol servers available to your agents.
          </p>
        </div>
      ...
      {mcps.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-lg border border-dashed py-16 text-center">
          ...
          <p className="text-muted-foreground font-medium mb-4">No MCP servers configured.</p>
          <Button onClick={() => setDialog({ isNew: true })}>
            <Plus className="h-4 w-4 mr-2" />
            Add MCP
          </Button>
